...
var ConverterMap = require('../converter-map');

var defmerge = require('../util/merge');
  ...
  // custom level 2 sections, such as history
    ...
    if(token.raw && !this.inList) {
      ...
      //if(this.level === 2) {
        ...
        //if(append) {
          //this.conf.help.sections[this.section.toLowerCase()] += token.raw;
        //}
